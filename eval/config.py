...
通过环境变量覆盖默认值：
    EVAL_MODEL=gpt-4o-mini python eval/run_eval.py ...
"""
...
# ── 路径 ──────────────────────────────────────────────
SKILL_ROOT = Path(__file__).resolve().parent.parent  # 项目根目录
...
SKILL_FILES = [
    SKILL_ROOT / "SKILL.md",
    SKILL_ROOT / "workflows" / "chart-analysis-workflow.md",
    SKILL_ROOT / "workflows" / "output-templates.md",
    SKILL_ROOT / "workflows" / "trading-decision.md",
]
